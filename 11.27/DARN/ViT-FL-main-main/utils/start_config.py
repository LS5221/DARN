...
def initization_configure(args, vis=False):
    ...
    args.output_dir = os.path.join(args.output_dir, args.FL_platform, args.dataset,args.missingtype, args.missingrate, args.name)
